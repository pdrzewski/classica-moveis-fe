...
export default function CadastroCliente({ onSuccess }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      await api.post('/clientes', payload).catch(() => api.post('/api/clientes', payload));
      onSuccess?.();
    } catch (err) {
      setError(err.response?.data?.message || err.message || 'Erro ao cadastrar cliente');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <form onSubmit={handleSubmit} className="form-cadastro-funcionario">
      <div className="form-grid">
        ...
        <div className="grupo-entrada grupo-amplo">
